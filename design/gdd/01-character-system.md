...
| 本GDD章节 | 对应文档 | 对齐状态 | 备注 |
|-----------|----------|:--------:|------|
| §8.3 传承点公式 | `08-failure-growth.md` §7.6 | ✅ 已对齐 | 统一为 `floor(xp/1000)` |
...
| **传承点公式** | floor(xp/1000) | floor(xp/500~2000) | 死亡遗产价值 | 分母越大，遗产越微薄 |
...
| 传承点数 | floor(dead_character_total_xp / 1000) | 可用于购买传承加成 |
...
| AC-5 | 传承点公式与failure-growth对齐 | 跨文档验证 | 两个GDD使用相同公式：floor(xp/1000) |
