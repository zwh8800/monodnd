...
>
> **⚠️ 已知设计缺口 (2026-05-09, `/review-all-gdds`)**: 酒馆升级材料（铁锭、石材、水晶粉、龙鳞碎片等）的获取机制、掉落率和交易规则未在任何 GDD 中定义。材料经济是实现酒馆升级的前置依赖——建议在 Phase 2 前完成独立设计文档。
> - 受影响: 酒馆升级(§2.5)、装备修复(03-items §6.4)、打造系统(03-items §8)
> - 建议: 新建 `design/gdd/10-material-economy.md` 或在 items-equipment.md 中补充材料获取章节
