...
> **Status**: Draft
> **Created**: 2026-05-08
> **Last Updated**: 2026-05-09 (`/review-all-gdds` 最终裁决: CONCERNS — 17/18阻断解决)
...
| 6 | 角色系统 (Character System) | Gameplay | MVP | In Review | `design/gdd/01-character-system.md` | 骰子, 事件总线 |
| 7 | 物品装备系统 (Items & Equipment) | Gameplay | MVP | In Review | `design/gdd/03-items-equipment.md` | 角色, 事件总线 |
| 8 | 条件效果系统 (Status Effects) | Gameplay | MVP | Designed | `design/gdd/10-condition-effects-system.md` | 角色, 事件总线 |
| 9 | 世界状态系统 (World State) | Persistence | MVP | Not Started | — | 事件总线 |
| 10 | LLM集成网关 (LLM Gateway) | Narrative | MVP | In Review | `design/gdd/02-llm-integration.md` | 事件总线 |
| 11 | 敌人AI系统 (Enemy AI) | Gameplay | MVP | Designed | `design/gdd/11-enemy-ai-system.md` | 角色, 条件效果 |
| 12 | 地图探索系统 (Map & Exploration) | Gameplay | MVP | In Review | `design/gdd/05-map-exploration.md` | 骰子, 场景管理 |
| 13 | 战斗系统 (Combat System) | Gameplay | MVP | In Review | `design/gdd/04-combat-system.md` | 角色, 物品装备, 条件效果, 骰子, 敌人AI |
| 14 | 冒险生成系统 (Adventure Generation) | Gameplay | MVP | In Review | `design/gdd/06-adventure-generation.md` | LLM网关, 世界状态, 地图探索 |
| 15 | 对话系统 (Dialogue System) | Narrative | MVP | Not Started | — | LLM网关, 角色 |
| 16 | 酒馆系统 (Tavern System) | Gameplay | MVP | In Review | `design/gdd/07-tavern-system.md` | 角色, 物品装备, 冒险生成 |
| 17 | 失败与成长系统 (Failure & Growth) | Progression | MVP | In Review | `design/gdd/08-failure-growth.md` | 角色, 战斗, 世界状态, LLM网关 |
| 19 | UI系统 (UI/UX) | UI | MVP | In Review | `design/gdd/09-ui-ux-design.md` | 所有游戏系统 |
...
| Design docs started | 9 (existing `design/gdd/` — 已迁移) |
...
| MVP systems designed | 13 / 19 |
| MVP systems designed | 8 / 19 |
...
- [ ] Review and update existing `design/gdd/*.md` to follow 8-section GDD format
...
| `design/gdd/02-llm-integration.md` | 4300+ | #10 LLM网关 | In Review — v1.1 修订完成 |
| `design/gdd/03-items-equipment.md` | 2600+ | #7 物品装备系统 | In Review — v1.1 修订完成 |
| `design/gdd/04-combat-system.md` | 2500+ | #13 战斗系统 | In Review — v1.2 修订完成 (疲乏/结算管线/认知过载/条件引用修复) |
...
| `design/gdd/08-failure-growth.md` | 2284 | #17 失败与成长系统 | In Review — v1.2 修订完成 (结算管线权威/Lv4真空标注) |
| `design/gdd/09-ui-ux-design.md` | 1927 | #19 UI系统 | Reference during GDD authoring |
| `design/gdd/GDD-v1.md` | 1029 | Game design canon | In Review — v1.2 修订完成 (背包/解锁/法术位/Pillar3修复) |
