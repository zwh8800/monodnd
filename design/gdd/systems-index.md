...
| 6 | 角色系统 (Character System) | Gameplay | MVP | Not Started | `docs/subsystems/01-character-system.md`* | 骰子, 事件总线 |
| 7 | 物品装备系统 (Items & Equipment) | Gameplay | MVP | Not Started | `docs/subsystems/03-items-equipment.md`* | 角色, 事件总线 |
| 8 | 条件效果系统 (Status Effects) | Gameplay | MVP | Not Started | — | 角色, 事件总线 |
| 9 | 世界状态系统 (World State) | Persistence | MVP | Not Started | — | 事件总线 |
| 10 | LLM集成网关 (LLM Gateway) | Narrative | MVP | Not Started | `docs/subsystems/02-llm-integration.md`* | 事件总线 |
| 11 | 敌人AI系统 (Enemy AI) | Gameplay | MVP | Not Started | — | 角色, 条件效果 |
| 12 | 地图探索系统 (Map & Exploration) | Gameplay | MVP | Not Started | `docs/subsystems/05-map-exploration.md`* | 骰子, 场景管理 |
| 13 | 战斗系统 (Combat System) | Gameplay | MVP | Not Started | `docs/subsystems/04-combat-system.md`* | 角色, 物品装备, 条件效果, 骰子, 敌人AI |
| 14 | 冒险生成系统 (Adventure Generation) | Gameplay | MVP | Not Started | `docs/subsystems/06-adventure-generation.md`* | LLM网关, 世界状态, 地图探索 |
| 15 | 对话系统 (Dialogue System) | Narrative | MVP | Not Started | — | LLM网关, 角色 |
| 16 | 酒馆系统 (Tavern System) | Gameplay | MVP | Not Started | `docs/subsystems/07-tavern-system.md`* | 角色, 物品装备, 关系(VS), 冒险生成 |
| 17 | 失败与成长系统 (Failure & Growth) | Progression | MVP | Not Started | `docs/subsystems/08-failure-growth.md`* | 角色, 战斗, 世界状态, LLM网关 |
| 18 | 存档系统 (Save/Load) | Persistence | MVP | Not Started | — | 角色, 世界状态, 酒馆 |
| 19 | UI系统 (UI/UX) | UI | MVP | Not Started | `docs/subsystems/09-ui-ux-design.md`* | 所有游戏系统(展示层) |
