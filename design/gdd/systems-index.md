...
> **Status**: Draft
> **Created**: 2026-05-08
> **Last Updated**: 2026-05-09 (`/review-all-gdds` 综合评审完成，裁决 FAIL)
...
| 6 | 角色系统 (Character System) | Gameplay | MVP | Needs Revision | `design/gdd/01-character-system.md` | 骰子, 事件总线 |
...
| 13 | 战斗系统 (Combat System) | Gameplay | MVP | Needs Revision | `design/gdd/04-combat-system.md` | 角色, 物品装备, 条件效果, 骰子, 敌人AI |
| 14 | 冒险生成系统 (Adventure Generation) | Gameplay | MVP | Needs Revision | `design/gdd/06-adventure-generation.md` | LLM网关, 世界状态, 地图探索 |
| 15 | 对话系统 (Dialogue System) | Narrative | MVP | Not Started | — | LLM网关, 角色 |
| 16 | 酒馆系统 (Tavern System) | Gameplay | MVP | Needs Revision | `design/gdd/07-tavern-system.md` | 角色, 物品装备, 冒险生成 |
| 17 | 失败与成长系统 (Failure & Growth) | Progression | MVP | Needs Revision | `design/gdd/08-failure-growth.md` | 角色, 战斗, 世界状态, LLM网关 |
...
| Design docs reviewed | 9 (全部9个现存GDD审查完成。`/review-all-gdds` 2026-05-09 裁决: FAIL — 18 阻断 + 30 警告) |
| Design docs approved | 0 |
| GDDs flagged Needs Revision | 6 (`01-character`, `04-combat`, `06-adventure`, `07-tavern`, `08-failure`, `GDD-v1`) |
...
|-------------|-------|-----------------|--------|
| `design/gdd/01-character-system.md` | 2700+ | #6 角色系统 | Needs Revision — 疲乏Lv3矛盾、DEX偏斜、条件所有权 |
...
| `design/gdd/04-combat-system.md` | 2500+ | #13 战斗系统 | Needs Revision — 疲乏Lv3矛盾、认知过载、结算管线冲突 |
| `design/gdd/05-map-exploration.md` | 2465 | #12 地图探索系统 | Reference during GDD authoring |
| `design/gdd/06-adventure-generation.md` | 2766 | #14 冒险生成系统 | Needs Revision — GDScript→C#翻译、结算管线统合 |
| `design/gdd/07-tavern-system.md` | 2190 | #16 酒馆系统 | Needs Revision — 金币→XP移除、材料经济、过期路径 |
| `design/gdd/08-failure-growth.md` | 2284 | #17 失败与成长系统 | Needs Revision — 结算管线统合、XP减半重新评估 |
| `design/gdd/09-ui-ux-design.md` | 1927 | #19 UI系统 | Reference during GDD authoring |
| `design/gdd/GDD-v1.md` | 1029 | Game design canon | Needs Revision — 背包公式、酒馆解锁、MVP Pillar 3 |
