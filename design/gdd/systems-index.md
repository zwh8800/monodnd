...
> **Status**: Draft
> **Created**: 2026-05-08
> **Last Updated**: 2026-05-10（#12 地图探索系统 `/design-review` 批准 — v1.2，7硬阻断+8结构性修复已应用；#14 冒险生成 GDD-v1.md v1.4 Approved）
...
| 2 | 骰子系统 (Dice System) | Core | MVP | Designed | `design/quick-specs/dice-system-2026-05-09.md` | — |
| 3 | 场景管理 (Scene Management) | Core | MVP | Designed | `design/quick-specs/scene-management-2026-05-09.md` | — |
| 4 | 设置选项系统 (Settings/Options) | Meta | MVP | Designed | `design/quick-specs/settings-options-2026-05-09.md` | — |
| 5 | 音频系统 (Audio System) | Audio | MVP | Designed | `design/quick-specs/audio-system-2026-05-09.md` | — |
| 6 | 角色系统 (Character System) | Gameplay | MVP | Approved | `design/gdd/01-character-system.md` | 骰子, 事件总线 |
| 7 | 物品装备系统 (Items & Equipment) | Gameplay | MVP | Approved | `design/gdd/03-items-equipment.md` | 角色, 事件总线 |
| 8 | 条件效果系统 (Status Effects) | Gameplay | MVP | Approved | `design/gdd/10-condition-effects-system.md` | 角色, 事件总线 |
| 9 | 世界状态系统 (World State) | Persistence | MVP | Not Started | — | 事件总线 |
| 10 | LLM集成网关 (LLM Gateway) | Narrative | MVP | Approved | `design/gdd/02-llm-integration.md` | 事件总线 |
| 11 | 敌人AI系统 (Enemy AI) | Gameplay | MVP | **Approved** | `design/gdd/11-enemy-ai-system.md` | 角色, 条件效果, 战斗(04§11), 地图探索 |
| 12 | 地图探索系统 (Map & Exploration) | Gameplay | MVP | Approved | `design/gdd/05-map-exploration.md` | 骰子, 场景管理 |
| 13 | 战斗系统 (Combat System) | Gameplay | MVP | Approved | `design/gdd/04-combat-system.md` | 角色, 物品装备, 条件效果, 骰子, 敌人AI |
| 14 | 冒险生成系统 (Adventure Generation) | Gameplay | MVP | Approved | `design/gdd/06-adventure-generation.md` | LLM网关, 世界状态, 地图探索 |
| 15 | 对话系统 (Dialogue System) | Narrative | MVP | Designed | `design/quick-specs/dialogue-system-2026-05-09.md` | LLM网关, 角色 |
| 16 | 酒馆系统 (Tavern System) | Gameplay | MVP | Approved ⚠️ | `design/gdd/07-tavern-system.md` | 角色, 物品装备, 冒险生成, 战斗, 失败与成长, 世界状态 |
| 17 | 失败与成长系统 (Failure & Growth) | Progression | MVP | Approved | `design/gdd/08-failure-growth.md` | 角色, 战斗, 世界状态, LLM网关 |
| 18 | 存档系统 (Save System) | Persistence | MVP | Designed | `design/quick-specs/save-system-2026-05-09.md` | 角色, 世界状态, 酒馆 |
| 19 | UI系统 (UI/UX) | UI | MVP | Approved | `design/gdd/09-ui-ux-design.md` | 所有游戏系统 |
| 20 | 关系系统 (Relationship) | Narrative | VS | Not Started | — | 角色 |
...
> \* 现有 `design/gdd/` 中的设计文档为详细子系统规格说明，已迁移至统一位置。
...
| Design docs started | 11 (01-11 子系统 GDD + GDD-v1 + game-concept) |
| Design docs reviewed | 11 (全部11个现存GDD审查完成。`/review-all-gdds` 2026-05-09 最终裁决: CONCERNS — 17/18阻断解决，0待处理) |
| Design docs with 8/8 sections | 12 (全部 GDD 完成 8 标准章节完整性检查 2026-05-10) |
| Design docs `/design-review` approved | 8 (`GDD-v1.md` — v1.4；`03-items-equipment.md` — v1.2；`05-map-exploration.md` — v1.2；`06-adventure-generation.md` — v1.3；`07-tavern-system.md` — ⚠️ 修订批准；`08-failure-growth.md` — 2026-05-10 v1.3, 12阻断已修复；`09-ui-ux-design.md` — v1.1；`10-condition-effects-system.md` — v1.1；`11-enemy-ai-system.md` — v2.0) |
| GDDs flagged Needs Revision | 0 (全部阻断问题已修复) |
| New GDDs created | 2 (`10-condition-effects-system.md` #8, `11-enemy-ai-system.md` #11) |
| MVP systems designed | 19 / 19 |
| Quick specs created | 6 (`dice-system`, `scene-management`, `dialogue-system`, `settings-options`, `audio-system`, `save-system`) |
...
- [x] Design MVP-tier systems first — `骰子系统` (design order #2) ✅ Quick spec done
- [x] 8 标准章节完整性检查 — 全部 12 份 GDD 通过 (2026-05-10)；3 份 GDD 修复完成 (04/09/02)
- [ ] Run `/design-review` on each completed GDD（GDD-v1 已批准；剩余 11 份逐个审查）
...
|-------------|-------|-----------------|--------|
| `design/gdd/01-character-system.md` | 2700+ | #6 角色系统 | In Review — v1.2 修订完成 (疲乏/DEX/法术位/条件修复) |
| `design/gdd/02-llm-integration.md` | 5757 | #10 LLM网关 | In Review — v1.2 修订完成（补全开发者/玩家体验说明）；8/8 章节 |
| `design/gdd/03-items-equipment.md` | 3498 | #7 物品装备系统 | **Approved** — v1.2 MAJOR REVISION 完成（11阻断已修复：附魔81%机制化+程序化叙事+定价解耦+耐久MVP移除+鉴定新系统+AC可测试化） |
| `design/gdd/04-combat-system.md` | 3102 | #13 战斗系统 | In Review — v1.2 修订完成 (疲乏/结算管线/认知过载/条件引用修复)；8/8 章节（补全玩家体验幻想） |
| `design/gdd/05-map-exploration.md` | 2655 | #12 地图探索系统 | **Approved** — v1.2 修订完成 (7硬阻断+8结构性修复：.tres格式修复/MVP分支节点/被动察觉重设计/FOV统一/火灾修复/WCAG修复等) |
| `design/gdd/06-adventure-generation.md` | 2766 | #14 冒险生成系统 | In Review — v1.2 修订完成 (结算管线委托/GDScript路线图) |
| `design/gdd/07-tavern-system.md` | 2190 | #16 酒馆系统 | In Review — v1.2 修订完成 (金XP删除/解锁修复/叙事包装) |
| `design/gdd/08-failure-growth.md` | 2349 → v1.3 | #17 失败与成长系统 | **Approved** — v1.3 MAJOR REVISION 完成（12阻断已修复：传承公式→level+5/伤疤补偿降级/速度奖励移除/参与度乘数重构/复活门槛提高/公式矛盾/测试修正） |
| `design/gdd/09-ui-ux-design.md` | 2108 | #19 UI系统 | In Review — 8/8 章节（补全公式/边界情况/验收标准）；GIVEN/WHEN/THEN 格式 |
| `design/gdd/10-condition-effects-system.md` | 506 (v1.1) | #8 条件效果系统 | **Approved** — v1.1 修订完成（8阻断+6建议修复：公式/传递条件/API契约/事件负载/AC扩展） |
| `design/gdd/11-enemy-ai-system.md` | 323 | #11 敌人AI系统 | **Approved** — v2.0 MAJOR REVISION (2026-05-10 CD裁决: 9项阻塞已解决——权重向量体系替代单一公式, 两阶段协作, 有界化威胁分, 行为级AC) |
| `design/gdd/GDD-v1.md` | 1406 | Game design canon | **Approved** — v1.4 修订完成（第二次 `/design-review` 2026-05-10，5阻塞已解决） |
