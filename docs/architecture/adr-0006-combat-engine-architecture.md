...
| **References Consulted** | `docs/GDD-v1.md` §5（战斗系统设计哲学与 DND 5e 偏离规则）、`docs/subsystems/04-combat-system.md`（完整 FSM/行动/管线/法术/条件/AI）、`docs/subsystems/01-character-system.md`（HP/AC/属性/熟练/死亡豁免）、`docs/subsystems/03-items-equipment.md`（武器伤害骰/护甲 AC 公式/附魔效果） |
...
- `docs/subsystems/04-combat-system.md` — 完整战斗系统技术设计（2400+ 行）
- `docs/subsystems/01-character-system.md` — 角色数据模型（战斗引擎读取接口）
- `docs/subsystems/03-items-equipment.md` — 武器/护甲数据模型
