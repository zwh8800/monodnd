...
| **References Consulted** | `docs/GDD-v1.md`、`docs/technical/02-overall-architecture.md` §1.1-1.2、`docs/subsystems/02-llm-integration.md`（4213 行完整设计）、`docs/subsystems/06-adventure-generation.md` |
...
- `docs/subsystems/02-llm-integration.md` — 完整 LLM 集成架构设计（4213 行）
- `docs/subsystems/06-adventure-generation.md` — 三层冒险生成管线
