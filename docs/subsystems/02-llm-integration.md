...
class SchemaValidator:
    ...
    func _load_schemas():
        _schemas["screenwriter"] = _parse_schema_file("schemas/adventure_blueprint.json")
        _schemas["dm_agent"] = _parse_schema_file("schemas/dm_agent_output.json")
        _schemas["copywriter"] = _parse_schema_file("schemas/copywriter_output.json")
        _schemas["balancer"] = _parse_schema_file("schemas/balance_report.json")
